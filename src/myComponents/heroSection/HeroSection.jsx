...
const HeroSection = () => {
  ...
  useEffect(() => {
	...
	return (
		<>
			<div className="heroSection vh-100 position-relative" data-scroll-section>
				...
				<div className="d-flex justify-content-center flex-column container h-100">
					<div className="row w-100 align-items-center">
						...
						<div className="col-6 imgParent" ref={stickyChildRef} style={{height: '160px'}}>
							<img className='h-100 w-100 object-fit-cover heroImg position-absolut top-0 start-0' src={img} alt="" />
						</div>
					</div>
			...
			<div className="container-fluid py-5 tastemakerssection" ref={parentRef} data-scroll-section>
