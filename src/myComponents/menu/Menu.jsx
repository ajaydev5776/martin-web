                        ...
                        <div className="row row-gap-2">
                            ...
                            <div className="col-12">
                                <ul className="list-unstyled navs d-flex flex-column gap-2">
                                    <li className="items"><Link to={SERVICE_URL} className="text-decoration-none itemlink rounded-pill px-3 position-relative d-flex align-items-center justify-content-between">services <span className="d-inline-flex position-relative pe-1"><img src="assets/img/arrow-right.svg" className="h-100" alt=""/></span></Link></li>
