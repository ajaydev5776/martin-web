        ...
        <div className="container-fluid innerfluid py-5">
            <div className="container-lg mt-5">
                <div className="row pt-sm-5 align-items-center ">
                    <div className="col-12 mt-xl-5 mb-md-0 mb-2"><div className="aboutusheading countHeading fw-light text-white">About</div></div>
                    <div className="col-md-6 col-sm-7">
                        <div className="row row-gap-4">
                            <div className="col-12 fs-2 text-theme1">Augustinus Bader</div>
                            <div className="col-12 textcontent ">Inspired by over three decades of science and innovation, Augustinus Bader’s award-winning approach to professional skincare is rooted in groundbreaking stem cell research and trusted by the world’s most discerning experts. Professor Bader’s clean, efficient formulas are powered by TFC8®, a proprietary cellular renewing technology clinically proven to help support the body’s natural regenerative processes, for a fresh, healthy glow from the inside out.</div>
                            <div className="col-sm-10 text-end">
                                <a href="javascript:;" className="text-decoration-none bg-transparent border border-1 border-theme1 d-inline-flex align-items-center gap-2 conceptBtn py-lg-2 py-1 px-4 rounded-pill">more <span className="d-inline-flex"><img src="assets/img/arrow.svg" className="w-100" alt="arrow"/></span></a>
                            </div>
                        </div>
                    </div>
        ...
        <div className="container-lg innerfluid">
            <div className="row align-items-center row-gap-3">
                <div className="col-md-6">
                    <div className="fs-3 textcontent">To enhance the personalized benefits, schedule a series of custom treatments and make The Method part of your Augustinus Bader skincare regimen.</div>
                </div>
