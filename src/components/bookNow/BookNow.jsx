...
import leaders_club from './../../Assets/leaders-club.png'
import './style.css'
const BookNow = () => {
return (
<>
<aside className="overlay has_transition_1000" id="bookOverlay">
   ...
   <form className="overlayContainer">
      ...
      <div className="ovGroup d-flex flex-lg-row align-items-lg-center flex-column align-items-start bookArrival no_overflow">
         <label for="bookArrival" className="has_transition_1500 overlayLabel detailTitle cWhite top_single d100">Your Name</label>
		 <input type="text" id="bookArrival" className="cMarrone  shadow-none ms-lg-4 ms-0 w-100 detailTitle top_single has_transition_1500 d200"/>
      </div>
      <div className="ovGroup d-flex flex-lg-row align-items-lg-center flex-column align-items-start bookDeparture no_overflow">
         <label for="bookDeparture" className="has_transition_1500 overlayLabel detailTitle cWhite top_single d300">Mobile Number</label>
		 <input type="text" id="bookDeparture" className="cMarrone  shadow-none ms-lg-4 ms-0 w-100 detailTitle top_single has_transition_1500 d400"/>
      </div>
	  <div className="ovGroup d-flex flex-lg-row align-items-lg-center flex-column align-items-start bookDeparture no_overflow">
         <label for="bookemail" className="has_transition_1500 overlayLabel detailTitle cWhite top_single d300">Email</label>
		 <input type="text" id="bookemail" className="cMarrone  shadow-none ms-lg-4 ms-0 w-100 detailTitle top_single has_transition_1500 d400"/>
      </div>
      ...
      <div id="bookSubmit" className="oButton whiteArrow has_transition_1500 top_ultralow d600" data-disabled="true">
         ...
         <div className="oContent">
            ...
            <div className="oLabelContainer no_overflow"><span className="oLabel top_hidden has_transition_1000 block cBrown d800 transition_all">submit</span></div>
         </div>
      ...
      <a className="ovGroup no_overflow leaders" target="_blank" href="javascript:;">
         <div className="ovSmall cMarrone no_overflow"><span className="block has_transition_1500 top_single d700">Member of <img src={leaders_club}/>? <br />Click <u>here</u> to enjoy enhanced stays and special benefits!</span></div>
      </a>
   </form>
</aside>
</>
