...
return (
<>
<header className="has_transition_400 ps-2">
   <div id="leftHeader" className="ms-1">
      <div
      id="mainMenuController"
      className={`menuController relative ${darkHeader ? 'dark' : ''}`}
      data-disabled="true"
      >
   ...
   <Link
      id="mainLogo"
      className="dark urlManager hidden has_transition_1500"
      to={HOME_URL}
      data-disabled="true"
      >
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 854.56 135.26">
      ...
      <use
         className="fillColor quickColor"
         x="0"
         y="0"
         xlinkHref="#caLogo"
         />
   ...
   <div className={`langsContainer has_transition_1500 mobileHidden ${darkHeader ? 'dark' : ''}`}>
   <ul className="langs cWhite list-unstyled m-0">
      <li className="lang-item lang-item-2 lang-item-en current-lang lang-item-first">
         <a href="javascript:;">german</a>
      </li>
      <li className="lang-item lang-item-7 lang-item-it">
   ...
   <div id="rightHeader">
      <a
      className={`fb has_transition_1500 headerButton ${darkHeader ? 'dark' : ''}`}
      target="_blank"
      href="javascript:;"
      data-disabled="true"
      >
      <svg
         className="circlePath mobileHidden has_transition_1000 d400"
         xmlns="http://www.w3.org/2000/svg"
         >
         <circle
            className="has_transition_1000 transition_all fillColor"
            cx="19"
            cy="19"
            r="18"
            stroke-width="1.3"
      ...
      <svg
         className="icon has_transition_1000 d500"
         xmlns="http://www.w3.org/2000/svg"
         width="16"
         height="16"
         viewBox="0 0 24 24"
         >
         <path
            className="fillColor transition_all has_transition_1000"
            d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"
            />
      </svg>
      </a>
      <a
      className={`ig has_transition_1500 headerButton d50 ${darkHeader ? 'dark' : ''}`}
      target="_blank"
      href="javascript:;"
      data-disabled="true"
      >
      <svg className="circlePath mobileHidden has_transition_1000 d200">
         <circle
            className="has_transition_1000 transition_all fillColor"
            cx="19"
            cy="19"
      ...
      <svg
         xmlns="http://www.w3.org/2000/svg"
         className="icon has_transition_1000 d300"
         width="18"
         height="17"
         viewBox="0 0 24 24"
         >
      ...
      href="javascript:;"
      target="_blank"
      className={`email has_transition_1500 headerButton d150 ${darkHeader ? 'dark' : ''}`}
      data-disabled="true"
      >
      <svg
         className="icon has_transition_1000 d100"
         xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 26 26"
         >
         <path
      ...
      <svg
         className="circlePath mobileHidden has_transition_1000"
         xmlns="http://www.w3.org/2000/svg"
         >
         <circle
            className="has_transition_1000 transition_all fillColor"
      ...
      <div
      id="bookNow"
      className={`oButton whiteArrow has_transition_1500 top_ultralow ${darkHeader ? 'dark' : ''}`}
      data-disabled="true"
      >
      <svg
      ...
      <div className="oContent">
         ...
         <div className="oLabelContainer no_overflow">
            <span className="oLabel top_hidden has_transition_1000 d-sm-block d-none block cBrown d200 transition_all">
            Anfrage stellen 
            </span>
            <span className="oLabel top_hidden has_transition_1000 d-sm-none d-block block cBrown d200 transition_all">
            Anfrage 
            </span>
         </div>
      </div>
      <div className="oSymbol">
         ...
         <defs>
            <path
               id="buttonArrow"
               d="M14.29,0.62c-0.1-0.24-0.3-0.44-0.54-0.54C13.63,0.03,13.5,0,13.37,0H2.95c-0.55,0-1,0.45-1,1s0.45,1,1,1h8.01L0.29,12.66
